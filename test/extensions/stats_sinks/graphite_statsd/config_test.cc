...
class GraphiteStatsdConfigLoopbackTest : public testing::TestWithParam<Network::Address::IpVersion> {};
...
TEST(GraphiteStatsdConfigTest, ValidateFail) {
  NiceMock<Server::Configuration::MockServerFactoryContext> server;
  EXPECT_THROW(
      GraphiteStatsdSinkFactory().createStatsSink(envoy::config::metrics::v3::GraphiteStatsdSink(), server),
